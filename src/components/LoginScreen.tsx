...
export const LoginScreen: React.FC<LoginScreenProps> = ({ onLogin }) => {
  const [selectedRole, setSelectedRole] = useState<UserRole>('Governance Lead');
  ...
  const roles: { role: UserRole; icon: React.ReactNode; description: string }[] = [
    ...
    { role: 'Governance Lead', icon: <Scale className="w-6 h-6" />, description: 'Governance framework and policy oversight' },
    { role: 'FinOps Analyst', icon: <TrendingUp className="w-6 h-6" />, description: 'Cost optimization and analysis' },
    { role: 'Finance Manager', icon: <DollarSign className="w-6 h-6" />, description: 'Financial operations and reporting' },
  ...
  const handleLogin = (e: React.FormEvent) => {
    ...
    const userData: User = {
      ...
      name: selectedRole === 'CFO' ? 'Sarah Johnson' :
            selectedRole === 'Governance Lead' ? 'Priya Sharma' :
            selectedRole === 'FinOps Analyst' ? 'Michael Chen' :
            selectedRole === 'Finance Manager' ? 'Arjun Patel' :
            selectedRole === 'Cloud Manager' ? 'David Rodriguez' : 
            selectedRole === 'CISO' ? 'Jennifer Kim' : 'Rajesh Sharma',
      email: email || `${selectedRole.toLowerCase().replace(' ', '.')}@fingov.ai`,
      role: selectedRole,
    };
    onLogin(userData);
  };
        ...
        <div className="hidden lg:flex lg:w-1/2 bg-gradient-to-br from-blue-600 to-blue-800 p-12 flex-col justify-center">
          <div className="text-white">
            <div className="flex items-center mb-8">
              ...
              <div>
                <h1 className="text-3xl font-bold">FinGov.AI</h1>
                <p className="text-blue-200">AI-Powered Financial Governance for BFSI</p>
              </div>
            </div>
            <div className="space-y-6">
              <div className="flex items-start space-x-4">
                ...
                <div>
                  ...
                  <p className="text-blue-200 text-sm">Predict governance costs with 95% accuracy</p>
                </div>
              </div>
              <div className="flex items-start space-x-4">
                <div className="w-8 h-8 bg-blue-500 rounded-lg flex items-center justify-center flex-shrink-0">
                ...
                <div>
                  ...
                  <p className="text-blue-200 text-sm">Built for RBI, SEBI, IRDAI, and regulatory governance</p>
                </div>
              </div>
              <div className="flex items-start space-x-4">
                <div className="w-8 h-8 bg-blue-500 rounded-lg flex items-center justify-center flex-shrink-0">
                ...
                <div>
                  ...
                  <p className="text-blue-200 text-sm">Unified governance across all platforms</p>
                </div>
              </div>
              <div className="flex items-start space-x-4">
                <div className="w-8 h-8 bg-blue-500 rounded-lg flex items-center justify-center flex-shrink-0">
                ...
                <div>
                  ...
                  <p className="text-blue-200 text-sm">AI-driven governance impact modeling</p>
                </div>
              </div>
            </div>
          </div>
        ...
        <div className="w-full lg:w-1/2 p-12">
          <div className="max-w-md mx-auto">
            <div className="text-center mb-8">
              ...
              <p className="text-gray-600">Sign in to your FinGov.AI account</p>
            </div>
